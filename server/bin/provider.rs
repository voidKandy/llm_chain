...
async fn create_boot_node(addr: Option<String>) -> llm_chain::MainResult<Node<ProviderNode>> {
    ...
    let mut server_node = Node::<ProviderNode>::try_from_keys(
        keypair.clone(),
